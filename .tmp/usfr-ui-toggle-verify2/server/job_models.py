...
class JobSnapshot:
    ...
    pending_review_request: Mapping[str, Any] | None = None
    ...
    def from_dict(cls, value: Mapping[str, Any]) -> JobSnapshot:
        ...
        pending = payload.get("pending_review_request")
        if pending is not None:
            payload["pending_review_request"] = dict(pending)
        public_error = payload.get("public_error")
        if public_error is not None:
            payload["public_error"] = dict(public_error)
        return cls(**payload)
