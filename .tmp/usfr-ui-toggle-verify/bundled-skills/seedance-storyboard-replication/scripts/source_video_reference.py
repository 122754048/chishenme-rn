...
def materialize_source_video_reference(
    *,
    ...
    # A matching short source must still be re-muxed as a named bounded
    # reference.  Reusing the original file would upload the full source to
    # Seedance and leave no distinct slice identity for the frozen segment.
