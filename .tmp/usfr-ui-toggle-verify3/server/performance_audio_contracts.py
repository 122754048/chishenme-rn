...
def build_background_music_performance_contract_from_route(
    *,
    ...
    A source-song or classified uploaded-song confirmation route makes
    singing eligible. Complete verified lyric evidence still has to bind every
    line to the confirmed on-camera singer and source window. Missing or
    conflicting evidence must not guess a singer or lyric.
    """
    ...
    if mode not in {
        "pending_source_lyrics_confirmation",
        "pending_uploaded_song_lyrics_confirmation",
    }:
