...
class ServerIntakeArtifactsTest(unittest.TestCase):
    ...
    def test_background_music_is_an_extension_with_verified_audio_upload_metadata(self):
        source = {
            "object_key": "uploads/job-1/source.mp4",
            "sha256": "a" * 64,
            "size_bytes": 100,
        ...
        music = {
            "object_key": "uploads/job-1/song.mp3",
            "sha256": "b" * 64,
            "size_bytes": 200,
        ...
        class Store:
            def head(self, object_key):
                return dict(source if object_key.endswith("source.mp4") else music)
        ...
        self.assertEqual(
            manifest["extensions"]["background_music"],
            {
                ...
                "values": ["uploads/job-1/song.mp3"],
                "sha256": ["b" * 64],
                "content_type": "audio/mpeg",
                "metadata": [{
                    "object_key": "uploads/job-1/song.mp3", "sha256": "b" * 64,
                    "size_bytes": 200, "content_type": "audio/mpeg", "status": "completed", "store_verified": True,
                }],
