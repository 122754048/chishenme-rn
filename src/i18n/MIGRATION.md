...
| Explore | ✅ migrated | full migration; 13 patch-mode edits, summary card + saved areas + filter chips all via t() |
...
| Detail | ✅ migrated | full migration; share/alert/CTA + dietary card all via t(); calorie unit interpolated |
